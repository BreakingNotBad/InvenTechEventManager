...
namespace Service.Validators.Event
{
    public class CreateEventValidator : AbstractValidator<CreateEventDto>
    {
        ...
        public CreateEventValidator(IRepositoryManager repo)
        {
            _repo = repo;
            ...
            RuleForEach(x => x.EventExtraEquipments).SetValidator(new CreateEventExtraEquipmentValidator());
            ...
            RuleFor(x => x)
                ...
                .WithMessage("Assigned role OR Assigned people does not exist in requirement");
